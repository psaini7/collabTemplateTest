...
public class AbbFuseSwitchAutoCompleter  extends CompleterSkeleton {

    private Configuration configuration;
    private FuseSwitchAutoCompleterManager autoManager;
    ...
    private Component initAutoManager() {
	    ...
	    autoManager = new FuseSwitchAutoCompleterManager();
