...
public class FuseSwitchAutoCompleter { 
    ...
    */
    public FuseSwitchAutoCompleter(Component column, Configuration configurator) {
        this.column = column;
    ...
    */
    ...
    if (column.getStateVector().getVar(str).getLegalValues().size() == 7){
