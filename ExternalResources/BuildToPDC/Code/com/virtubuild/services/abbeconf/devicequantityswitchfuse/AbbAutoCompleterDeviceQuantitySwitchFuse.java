...
public class AbbAutoCompleterDeviceQuantitySwitchFuse  extends CompleterSkeleton {


    private Configuration configuration;
    private AutoCompleterManagerDeviceQuantitySwitchFuse autoManager;
    ...
    private Component initAutoManager() {
	    ...
	    autoManager = new AutoCompleterManagerDeviceQuantitySwitchFuse();
