...
public class AbbAutoCompleterDeviceQuantityFuseSwitch  extends CompleterSkeleton {

    private Configuration configuration;
    private AutoCompleterManagerDeviceQuantityFuseSwitch autoManager;
    ...
    private Component initAutoManager() {
	    ...
	    autoManager = new AutoCompleterManagerDeviceQuantityFuseSwitch();
