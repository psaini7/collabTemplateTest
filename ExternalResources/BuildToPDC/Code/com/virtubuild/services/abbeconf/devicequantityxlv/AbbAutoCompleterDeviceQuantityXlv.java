...
public class AbbAutoCompleterDeviceQuantityXlv  extends CompleterSkeleton {


    private Configuration configuration;
    private AutoCompleterManagerDeviceQuantityXlv autoManager;
    ...
    private Component initAutoManager() {
	    ...
	    autoManager = new AutoCompleterManagerDeviceQuantityXlv();
