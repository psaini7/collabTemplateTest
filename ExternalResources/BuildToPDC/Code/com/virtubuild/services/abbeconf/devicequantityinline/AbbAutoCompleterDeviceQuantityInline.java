...
public class AbbAutoCompleterDeviceQuantityInline  extends CompleterSkeleton {

    private Configuration configuration;
    private AutoCompleterManagerDeviceQuantityInline autoManager;
    ...
    private Component initAutoManager() {
	    ...
	    autoManager = new AutoCompleterManagerDeviceQuantityInline();
